...
?>
        <div class="dropzone-uploaded dropzoneUploadedJs">
            <img data-aspect-ratio=" <?php echo $getBadgeRatio[ImageDimension::VIEW_THUMB]['aspectRatio']; ?>" src="<?php echo $imgUrl; ?>" title="<?php echo $row['afile_name']; ?>" alt="<?php echo $row['afile_name']; ?>">
            <?php if ($canEdit) { ?>
