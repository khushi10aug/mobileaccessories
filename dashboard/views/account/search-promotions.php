            ...
            switch ($key) {
                case 'promotion_image':
                    if ($row['promotion_type'] == Promotions::PROMOTE_PRODUCT) {
                        $td->appendElement('plaintext', array(), '<div class="avtar"><img src="' . UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'product', array($product['promotion_product_id'], ImageDimension::VIEW_MINI, 0, 0, $siteLangId), CONF_WEBROOT_FRONTEND), CONF_IMG_CACHE_TIME, '.jpg') . '" alt="' . $row["prod_name"] . '"></div>', true);
            ...
            xlink:href="' . CONF_WEBROOT_URL . 'images/retina/sprite-actions.svg' . AttachedFile::setTimeParam(RELEASE_DATE) . '#edit">
                    ...
                    if ($row['promotion_status'] == 0) :
                        ...
                        $li->appendElement(
                            "a",
                            array(
                                'title' => Labels::getLabel('LBL_Enable', $siteLangId),
                        ...
                        $li->appendElement(
                            "a",
                            array(
                                'title' => Labels::getLabel('LBL_Disable', $siteLangId),
                    ...
                    $li->appendElement(
                        "a",
                        array(
                            'title' => Labels::getLabel('LBL_Analytics', $siteLangId),
