...
/* Seller subscription package description */
ALTER TABLE `tbl_seller_packages`
  ADD COLUMN `spackage_description` TEXT NULL AFTER `spackage_active`;
...
---------------------------------------------------------
DROP TABLE IF EXISTS `tbl_compatible_brands`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_compatible_brands` (
  `cbrand_id` int(11) NOT NULL AUTO_INCREMENT,
  `cbrand_identifier` varchar(200) NOT NULL,
  `cbrand_seller_id` int(11) NOT NULL,
  `cbrand_featured` tinyint(1) NOT NULL,
  `cbrand_active` tinyint(1) NOT NULL,
  `cbrand_status` tinyint(4) NOT NULL,
  `cbrand_deleted` tinyint(1) NOT NULL,
  `cbrand_comments` varchar(250) NOT NULL,
  `cbrand_updated_on` datetime NOT NULL DEFAULT current_timestamp(),
  `cbrand_requested_on` datetime NOT NULL,
  `cbrand_status_updated_on` datetime NOT NULL,
  PRIMARY KEY (`cbrand_id`),
  UNIQUE KEY `cbrand_identifier` (`cbrand_identifier`),
  KEY `cbrand_active` (`cbrand_active`),
  KEY `cbrand_deleted` (`cbrand_deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;


DROP TABLE IF EXISTS `tbl_compatible_brands_lang`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_compatible_brands_lang` (
  `cbrandlang_cbrand_id` int(11) NOT NULL,
  `cbrandlang_lang_id` int(11) NOT NULL,
  `cbrand_name` varchar(200) NOT NULL,
  `cbrand_short_description` varchar(250) NOT NULL,
  PRIMARY KEY (`cbrandlang_cbrand_id`,`cbrandlang_lang_id`),
  UNIQUE KEY `cbrandlang_lang_id` (`cbrandlang_lang_id`,`cbrand_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

ALTER TABLE `tbl_compatible_brands` ADD INDEX(`cbrand_active`);
ALTER TABLE `tbl_compatible_brands` ADD INDEX(`cbrand_deleted`);
INSERT INTO `tbl_pages_language_data` (`plang_id`, `plang_key`, `plang_lang_id`, `plang_title`, `plang_summary`, `plang_warring_msg`, `plang_recommendations`, `plang_replacements`, `plang_helping_text`) VALUES (NULL, 'MANAGE_COMPATIBLE_BRANDS', '-1', 'Compatible Brands', 'Manage all the compatible brands available on the platform (ex. name).', 'A compatible brand will be visible at the front end only if it is linked to a product(s). ', 'Deactivate a compatible brand if you do not want to use it for a specific period of time, instead of deleting it. ', '', '\r\n<ul>  \r\n	<li>Define the linking of a compatible brand to a product as optional/mandatory under System Settings > Configuration > Product tab.</li>  \r\n	  <li>compatible Brands will be visible at the front end, only if they are linked to a product(s).</li>  \r\n	<li>If a compatible brand is not being displayed at the front end or in the compatible brand list (to link it with a product), it might be because the product might have been marked as inactive.</li>\r\n</ul>\r\n<ul>\r\n</ul>     ');
ALTER TABLE `tbl_products` ADD `product_cbrand_id` INT(11) NOT NULL AFTER `product_brand_id`;
