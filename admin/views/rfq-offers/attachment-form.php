    ...
    <div class="messages-chat">
        ...
        <button class="btn-attachments btnAttachmentsJs" type="button">
            ...
            <svg class="svg" width="20" height="20">
                <use xlink:href="<?php echo CONF_WEBROOT_BACKEND; ?>images/retina/sprite.svg<?php echo AttachedFile::setTimeParam(RELEASE_DATE); ?>#attachments"></use>
            </svg>
        </button>
        <button class="btn-access btnSccessJs active" type="button" data-bs-toggle="tooltip" title="<?php echo Labels::getLabel('FRM_BUYER_ACCESS'); ?>">
            ...
            ?>
            <svg class="svg" width="20" height="20">
                <use xlink:href="<?php echo CONF_WEBROOT_BACKEND; ?>images/retina/sprite.svg<?php echo AttachedFile::setTimeParam(RELEASE_DATE); ?>#user-follow-line"></use>
            </svg>
        </button>
        <?php echo $frm->getFieldHtml('rom_message'); ?>
        <button class="btn-send btnSubmitJs" type="submit" disabled>
            <svg class="svg" width="20" height="20">
                <use xlink:href="<?php echo CONF_WEBROOT_BACKEND; ?>images/retina/sprite.svg<?php echo AttachedFile::setTimeParam(RELEASE_DATE); ?>#send"></use>
            </svg>
        </button>
