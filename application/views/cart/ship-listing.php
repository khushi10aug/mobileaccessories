...
<div class="cart-blocks">
    ...
    ?>
        ...
        <ul
            class="list-cart <?php echo (count($fulfillmentProdArr[Shipping::FULFILMENT_SHIP]) != $productsCount) ? '' : ''; ?>">
                        ...
                        <span class="not-pickup">
                            ...
                            <?php if (count($fulfillmentProdArr[Shipping::FULFILMENT_PICKUP]) == $productsCount) { ?>
                                <a class="link-underline" href="javascript:void(0);"
                                    onClick="listCartProducts(<?php echo Shipping::FULFILMENT_PICKUP; ?>);"><?php echo Labels::getLabel('LBL_Pickup_Entire_Order', $siteLangId); ?></a>
                            <?php } ?>
                        </span>
                        <button class="btn-close" onClick="removePickupOnlyProducts();" data-bs-toggle="tooltip"
                            data-placement="top"
                            title="<?php echo Labels::getLabel('MSG_REMOVE_PICKUP_ONLY_PRODUCTS', $siteLangId); ?>">
                        </button>
                    </div>
                </li>
                                ...
                                <div class="options">
                                    ...
                                    if (isset($product['options']) && count($product['options'])) {
                                        foreach ($product['options'] as $key => $option) {
                                            ...
                                            echo CommonHelper::renderHtml($option['option_name'], true) . ':'; ?> <span
            ...
            ?>
                <li
                    ...
                    <div class="block-cart-detail">
                        <div class="block-cart-detail-top">
                            <div class="product-profile">
                                <div class="product-profile-data">
                                    ...
                                    <a class="title" href="<?php echo $productUrl; ?>"><?php echo $productTitle; ?></a>
                                    <div class="products-price">
                                        <?php echo CommonHelper::displayMoneyFormat($product['theprice'], true, false, true, false, false, true); ?>
                                    </div>
                                    <div class="options">
                                        <?php
                                        if (isset($product['options']) && count($product['options'])) {
                        ...
                        <div class="block-cart-detail-bottom">
                            <ul class="cart-action">
                                <li class="cart-action-item"> <button class="btn btn-link" type="button"
