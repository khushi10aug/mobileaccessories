...
<table width="100%" border="0" cellpadding="10" cellspacing="0" class="tbl-border">
    <tbody>
        ...
        foreach ($childOrderDetail as $childOrder) {
            ...
            if (!is_null($sellerGstNumber) && !empty(trim($sellerGstNumber))) {
                $item .= '<br>' . Labels::getLabel('LBL_GST_Number', $siteLangId) . ': ' . $sellerGstNumber;
            }
            ...
            if (!is_null($childOrder['product_hsn_code']) && !empty(trim($childOrder['product_hsn_code']))) {
                $item .= '<br>';
                $item .= Labels::getLabel('LBL_HSN_Code', $siteLangId) . ': ' . $childOrder['product_hsn_code'];
            }
                ...
                <td>
                    <table class="tbl-border" width="100%" border="0" cellpadding="10" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding:10px;font-size:15px;text-align: <?php echo CommonHelper::getLayoutDirection() == 'rtl' ? 'right' : 'left'; ?>;font-weight:700; vertical-align: top;" colspan="<?php echo ($col6) ? '2' : '1'; ?>" rowspan="6">
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td height="60" style="padding:15px;vertical-align: top;"><strong><?php echo $childOrder['op_shop_name']; ?></strong><br><span><?php echo Labels::getLabel('LBL_Authorized_Signatory', $siteLangId); ?> </span>
                                </td>
