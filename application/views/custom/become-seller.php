...
<?php if ((isset($contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK3]['epage_content']) && $contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK3]['epage_content'] != '') || (isset($contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK4]['epage_content']) && $contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK4]['epage_content'] != '')) { ?>
	<section class="section section--pattern"
		style="background-image:url(<?php echo CONF_WEBROOT_URL; ?>images/pattern2.png); background-color:#1689e5;">
		<div class="container container--fixed">
			<div class="row">
								...
								<li>
									<div class=" box--content">
										<div class="box box--white">
											<p><span
													class="lessText"><?php echo CommonHelper::truncateCharacters(CommonHelper::renderHtml($story['sstory_content']), 200, '', '', true); ?></span>
												<?php /* if(strlen((string)$story['sstory_content']) > 200) { ?>
																		 <span class='moreText'
																			 hidden><?php echo nl2br($story['sstory_content']);?></span>
																		 <a class="readMore link--arrow btn-link" href="javascript:void(0);">
																			 <?php echo Labels::getLabel('Lbl_SHOW_MORE',$siteLangId) ; ?> </a>
																		 <?php } */ ?>
											</p>
											<h6>— <?php echo $story['sstory_name'];
											echo ($story['sstory_site_domain'] != '') ? ', <span>' . $story['sstory_site_domain'] . '</span>' : ''; ?>
											</h6>
										</div>
									</div>
								</li>
		...
		<div class="container container--fixed">
			...
			<div class="row">
				...
				<div class="align--center">
					<a href="<?php echo UrlHelper::generateUrl('Custom', 'faq'); ?>"
						class="btn btn-brand btn--h-large"><?php echo Labels::getLabel('LBL_View_All', $siteLangId) ?></a>
				</div>
			</div>
		</div>
	</section>
...
<?php if (isset($contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK7]['epage_content']) && $contentBlocks[Extrapage::BECOME_SELLER_PAGE_BLOCK7]['epage_content'] != '') { ?>
	<section class="section section--parallax align--center"
		style="background-image:url(<?php echo CONF_WEBROOT_URL; ?>images/section-bg.jpg);">
		<div class="container container--fixed">
